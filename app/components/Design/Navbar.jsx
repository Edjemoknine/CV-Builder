...
const Navbar = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 md:px-8">
      <div className="z-50 py-7 relative flex justify-between">
        <Link
          href={"/"}
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-3 text-sm">
            <Link
              className="px-4 py-2 rounded border hover:bg-sky-700 hover:text-white duration-300 border-sky-700 text-sky-700"
              href={"/wizard"}
            >
              Build My Resume
            </Link>
